...
export const Projects = () => {
  return (
    <section id="projetos" className="md:mt-[220px] mt-[120px] container">
      <h1 className="mb-12 font-main font-bold text-white text-2xl md:text-3xl max-w-[20ch] text-balance">
      ...
      <div className="grid *:rounded overflow-hidden max-md:grid-cols-1 grid-cols-3 content-center gap-4">
        ...
        <div className="flex justify-center flex-col gap-2 bg-azul-800 rounded text-white p-8 max-md:items-center md:col-span-1">
          <h2 className="font-bold font-text max-md:text-center  text-xl md:text-2xl max-w-[15ch]">
            Criação de abrigo para cães de rua
          </h2>
          <p className="text-lg font-text  md:text-xl max-md:text-center text-gray-400 mb-6">
            Abrigo JP, PB
          </p>
          <button className="flex font-text  gap-3 place-self-start max-md:place-self-center btn">
